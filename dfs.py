...
def GetDirection(i):
    directions_name = ('N', 'S', 'W', 'E')
    return directions_name[i]
...
def DFS():
    global stack_path, min_cost, move_cost, all_points, stack_cost, count, new_coordinate
    if len(stack_path) == 0:
        return
